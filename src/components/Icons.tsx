export function TwitterIcon({ className, ...rest }: { className?: string }) {
    return (
        <svg
...
export const CircularText: React.FC<CircularTextProps> = ({ className = "" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 100 100"
    ...
    >
      ...
      <text fontWeight={500} fontSize="11.45" textAnchor="middle">
...
interface XLogoProps extends React.SVGProps<SVGSVGElement> {
    size?: number; // Allows size customization
  }
  
export const XIcon: React.FC<XLogoProps> = ({ className, ...rest }: { className?: string }) => {
    return (
        <svg
        xmlns="http://www.w3.org/2000/svg"
        xmlSpace="preserve"
        ...
        height={25}
        viewBox="0 0 25 25"
        className={`w-full pt-px h-auto ${className}`}
        {...rest}
      >
